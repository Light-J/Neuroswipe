...
public class Profile {
    ...
    public Profile(Long id, Long accountId, String username, Integer age, Boolean disability, Boolean genderSexMatch, String sex, Integer ethnicityId, Integer religionId, Integer sexualOrientationId, Integer relationshipId) {
        this.id = id;
